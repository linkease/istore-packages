m = Map("qbittorrent_ee")
m.title = translate("qBittorrent EE")
m.description = translate("qBittorrent is a cross-platform free and open-source BitTorrent client (Enhanced Edition)")

m:section(SimpleSection).template = "qbittorrent_ee/qbittorrent_status"
